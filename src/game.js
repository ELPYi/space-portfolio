...
// HUD — launch is triggered by dynamic import in main.js, not by button click here
const hud = new HUD(() => {});

// Hide intro screen and launch immediately (init() = user clicked Launch)
...
// Mobile warning handled in main.js before lazy load
